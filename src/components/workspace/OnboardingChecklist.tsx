...
export const OnboardingChecklist = ({ hasSource, hasNodes, validated, onOpenTemplates }: { hasSource: boolean; hasNodes: boolean; validated: boolean; onOpenTemplates: () => void }) => {
  ...
  const steps = [
    { label: 'Choose a template or open the guided demo', done: hasNodes, action: onOpenTemplates },
    { label: 'Add or edit source material yourself', done: hasSource },
    { label: 'Resolve validation and approve required review', done: validated },
  ];
