    ...
    <div className="flex-1 overflow-y-auto p-6 sm:p-8 max-w-5xl mx-auto w-full">
      ...
      <div className="mb-10">
        ...
        <div className="mt-6 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5 max-w-3xl">
          ...
          <a href="mailto:davidelsey9513@gmail.com?subject=WeaveStudio%20acquisition%20inquiry" aria-label="Email davidelsey9513@gmail.com for acquisition inquiries" className="mt-4 inline-flex rounded-lg bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800">Email acquisition inquiries</a>
        </div>
      </div>
